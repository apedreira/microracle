...
tabPanel(
  ...
  sidebarLayout(sidebarPanel(
    fluidRow(
      column(10, 
             ...
             c("Escherichia coli" = "ecoli"), inline=TRUE),
  ...
  numericInput(inputId = "EC50_d",
             ...
             bsTooltip("EC50_d",
                       ...
                       "right",
                       options = list(container = "body")) ),
      column(3, numericInput(inputId = "gamma_a",
...
model2Server <- function(input, output, session) {
  observe({
    ...
    exp_df = data.frame(Time = unlist(simpleDataDDAC[1]),
    ...
    observeEvent(input$model2_tabsetPanel,{
      ...
      ###-------------------------------##  
        ...
        preset_df = data.frame(exp1_t= unlist(simpleDataDDAC[1]),
