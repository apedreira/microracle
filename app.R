...
ui <-
  navbarPage(
    ...
    tags$head(
      ...
      tags$style(
        HTML(
          ...
          ".navbar-nav > li:nth-child(4) {float: left;, margin-top: 10px}",
          ".navbar-nav > li:nth-child(5) {float: right;, margin-top: 10px}",
          ".navbar-nav > li:nth-child(6) {float: right;, margin-top: 10px}",
          ".navbar-nav > li:nth-child(5) a:nth-child(1) {display:none}",
          ".navbar-nav > li:nth-child(6) a:nth-child(1) {display:none}",
          ...
          # display: none;
          # }",
          # "#navbar > li:nth-child(3) > a:nth-child(1) {
          #  display: none;
          # }"
        )
      )
    ...
    #To uncomment once the new models have been included
    navbarMenu(
      "MODELS",
      #  model3UI(),
      # model4UI()
